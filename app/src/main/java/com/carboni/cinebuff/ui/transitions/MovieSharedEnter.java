package com.carboni.cinebuff.ui.transitions;
...
public class MovieSharedEnter extends ChangeBounds {
    public static final String PROPNAME_BOUNDS = "android:changeBounds:bounds";
    private static final String PROPNAME_PARENT = "android:changeBounds:parent";

    public MovieSharedEnter(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
